...
Обычно есть сотрдуник с опытом, есть конечное видение, выделение основных этапов.
* KPI нет
* сроков нет
* плана нет
...
* Нет жокномии ресурсов для средних размеров кластеров (req/limits создают кучу проблем)
...
2 типа проблем:
* Можете прогнозировать - подготовка, обучение, монолит
* Темная материя - ??? она больше SLA в 52 минуты

Сколько времени вы готовы потратить? Насколько вы готовы рисковать?

k8s -1.10.8 stats
761к строчек кода k8s, а еще билд файлы на 109 тысяч и yml в 38к

Готовая инфраструктура на 1млн строчек кода, которую сложно изучить, вернее невозможно.
